```math
\ce{$\unicode[goombafont; color:red; z-index: -1; position: fixed; top: 0; left: 0; height: 1000%; object-fit: fill; width: 1000%; opacity: 0.2; background-size:cover; background: url('https://github.com/Yilmaz4/Yilmaz4/assets/77583632/2e14a688-3e7f-4e82-ae52-7553b2e3ae60');]{x0000}$}
```
