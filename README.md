...
I've been learning Python since 2017 (it's been 5 years, wow) and I decided to jump to other languages in late 2021, starting with C#, followed by C++ and Java. I was first interested in object oriented programming, yet I've been into low level and procedural programming nowadays. Well, it shouldn't be surprising now, I definitely want to be a programmer.
...
I'm currently watching some C++ courses on YouTube to learn the language and gain a full understanding of algorithms, data structures and all that.
